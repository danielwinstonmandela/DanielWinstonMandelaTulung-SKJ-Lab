...
00000000000011a9 <main>:
    ...
    11b5:	c7 45 f4 05 00 00 00 	movl   $0x5,-0xc(%rbp)
    11bc:	c7 45 f8 0a 00 00 00 	movl   $0xa,-0x8(%rbp)
    11c3:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11c6:	0f af 45 f8          	imul   -0x8(%rbp),%eax
    11ca:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11cd:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11d0:	89 c6                	mov    %eax,%esi
    11d2:	48 8d 05 67 2e 00 00 	lea    0x2e67(%rip),%rax        # 4040 <_ZSt4cout@GLIBCXX_3.4>
    11d9:	48 89 c7             	mov    %rax,%rdi
    11dc:	e8 cf fe ff ff       	call   10b0 <_ZNSolsEi@plt>
    11e1:	48 8b 15 e8 2d 00 00 	mov    0x2de8(%rip),%rdx        # 3fd0 <_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_@GLIBCXX_3.4>
    11e8:	48 89 d6             	mov    %rdx,%rsi
    11eb:	48 89 c7             	mov    %rax,%rdi
    11ee:	e8 9d fe ff ff       	call   1090 <_ZNSolsEPFRSoS_E@plt>
...
00000000000011fa <_Z41__static_initialization_and_destruction_0ii>:
    ...
    120c:	83 7d fc 01          	cmpl   $0x1,-0x4(%rbp)
    1210:	75 3b                	jne    124d <_Z41__static_initialization_and_destruction_0ii+0x53>
    1212:	81 7d f8 ff ff 00 00 	cmpl   $0xffff,-0x8(%rbp)
    1219:	75 32                	jne    124d <_Z41__static_initialization_and_destruction_0ii+0x53>
    121b:	48 8d 05 2f 2f 00 00 	lea    0x2f2f(%rip),%rax        # 4151 <_ZStL8__ioinit>
    1222:	48 89 c7             	mov    %rax,%rdi
    1225:	e8 76 fe ff ff       	call   10a0 <_ZNSt8ios_base4InitC1Ev@plt>
    122a:	48 8d 05 d7 2d 00 00 	lea    0x2dd7(%rip),%rax        # 4008 <__dso_handle>
    1231:	48 89 c2             	mov    %rax,%rdx
    1234:	48 8d 05 16 2f 00 00 	lea    0x2f16(%rip),%rax        # 4151 <_ZStL8__ioinit>
    123b:	48 89 c6             	mov    %rax,%rsi
    123e:	48 8b 05 b3 2d 00 00 	mov    0x2db3(%rip),%rax        # 3ff8 <_ZNSt8ios_base4InitD1Ev@GLIBCXX_3.4>
    1245:	48 89 c7             	mov    %rax,%rdi
    1248:	e8 33 fe ff ff       	call   1080 <__cxa_atexit@plt>
    124d:	90                   	nop
    124e:	c9                   	leave  
    124f:	c3                   	ret    

0000000000001250 <_GLOBAL__sub_I_main>:
    1250:	f3 0f 1e fa          	endbr64 
    1254:	55                   	push   %rbp
    1255:	48 89 e5             	mov    %rsp,%rbp
    1258:	be ff ff 00 00       	mov    $0xffff,%esi
    125d:	bf 01 00 00 00       	mov    $0x1,%edi
    1262:	e8 93 ff ff ff       	call   11fa <_Z41__static_initialization_and_destruction_0ii>
    1267:	5d                   	pop    %rbp
    1268:	c3                   	ret    
